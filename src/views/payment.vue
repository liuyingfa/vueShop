  ...
  <div id="main">
    <div class="content page-order-payment">
      ...
      <div class="confirm-detail">
        ...
        <p class="info-detail">发票抬头：{{orderInfo.invoiceText}}</p>
        <p class="info-detail">发票内容：</p>
      </div>
      ...
      <div class="confirm-goods-table">
        <div class="cart-items clear" v-for=" goods in orderInfo.goodsData">
          <div class="name fn-left hide-row">
            <div class="name-cell">
              <a href="#" :title="goods.title"
                 target="_blank">{{goods.title+'('+goods.spec_json.show_name+')'}}</a><br>
            </div>
          </div>
          <div class="subtotal fn-right">
            <div class="subtotal-cell">¥ {{goods.count*goods.price}}.00</div>
          </div>
          <div class="goods-num fn-right">{{goods.count}}</div>
          <div class="price fn-right">¥ {{goods.price}}</div>
        </div>
      </div>
